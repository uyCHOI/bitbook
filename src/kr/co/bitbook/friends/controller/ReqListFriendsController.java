...
@WebServlet("/friedns/reqList")
public class ReqListFriendsController extends HttpServlet{
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		FriendsMapper mapper = MyAppSqlConfig.getSqlSession().getMapper(FriendsMapper.class);
		request.setCharacterEncoding("utf-8");
		List<Member> list = mapper.selectReqList(Integer.parseInt(request.getParameter("memNo")));
