...
@WebServlet("/member/addr")
public class ListAddrMember extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/member/viewMemberAddress.jsp");
