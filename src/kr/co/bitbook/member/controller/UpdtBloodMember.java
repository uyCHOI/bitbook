...
@WebServlet("/member/updtBlood")
public class UpdtBloodMember extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		memberDetail.setBlood(request.getParameter("blood"));
		MyAppSqlConfig.getSqlSession().getMapper(MemberMapper.class).updateBlood(memberDetail);
