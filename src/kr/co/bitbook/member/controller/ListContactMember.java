...
@WebServlet("/member/contact")
public class ListContactMember extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/member/viewMemberContact.jsp");
