...
@WebServlet("/member/updtProfile")
public class UpdtProfileMember extends HttpServlet{
...
//				long fileSize = f.length();
				...
				member.setProfilePath(uploadPath+datePath+"/"+mRequest.getFilesystemName(name));
				System.out.println(member.getProfilePath());
				member.setMemNo(Integer.parseInt(mRequest.getParameter("memNo")));
				MyAppSqlConfig.getSqlSession().getMapper(MemberMapper.class).updateProfile(member);
